...
- [X] T010 [US1] Wire Add Note to open VoiceNoteRecordModal with techniqueId and fight list mode; on Approve save via VoiceNoteService and refresh fight list notes in src/managers/FightListUIManager.ts
